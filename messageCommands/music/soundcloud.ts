...
async function soundcloudCommand(message: Message<true>, ...request: string[]) {
    ...
    if (request.length === 0) throw new BaseExceptions.UserError("Bạn phải nhập tên bài hát hoặc link soundcloud nhé!");
...
export default new NostalMessageCommand({
    ...
    usage: [Required("soundcloud_link")],
